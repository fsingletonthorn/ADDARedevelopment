...
In order to run the model, you'll first need to **save your file**, and set up some analysis options.
...
To take a look at the full output, you can either examine the factor loadings 
...
2) Take a look at the assessment of normality output. 

Are there any worrying signs of multivariate non-normality?

#### Questions 3 - 6

Navigate to the model fit page in the Amos output window. Taking a quick look at the fit indices that we discussed in class:

3) Do small or large chi square statistics indicate good fit? Does our chi square value indicate good fit? 

4) Do small or large SRMR values indicate good fit? How about our SRMR?

5)  Do small or large CFIs indicate good fit? How about our CFI? 

6) Do small or large RMSEAs indicate good fit? How about our RMSEA?
...
7) Does model fit improve? 

8) Does it make theoretical sense to correlate these factors?

9) Do any of the factor loadings noticeably change? 
...
Generally, .15 would not be considered good fit.
...
This means CFI values close to 1 are good - your model is greatly out-performing the null model indicating a very good fit. Values close to 0 are quite bad on the other hand. In this case we have a CFI of .77, which is not very good at all. 
...
**9) Do any of the factor loadings noticably change?** 
